...
- The mission-progress slot is empty until a mission page renders `ShowMissionProgress` (phase 06). There are no accounts, XP or levels, so the top bar has no profile or score.
